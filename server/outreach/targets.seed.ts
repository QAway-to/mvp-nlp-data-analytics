...
export const TARGET_SEEDS: ReadonlyArray<TargetSeed> = [
  ...
  { handle: 'saratov_taxi', city: 'Саратов', category: 'такси', title: 'Таксисты Саратова и области', members: 1949 },
  ...
  { handle: 'krasnoyarsk_chat', city: 'Красноярск', category: 'город-чат', title: 'Красноярск чат', members: 2166 },
  { handle: 'barnaul22', city: 'Барнаул', category: 'город-чат', title: 'Barnaul 22', members: 83641 },
]
