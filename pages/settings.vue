            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="space-y-1">
                        ...
                        <input type="text" value="Ilya Zaigralov" class="w-full px-3 py-2 rounded-lg border border-here-gray-200 focus:ring-2 focus:ring-here-purple-500 focus:border-transparent outline-none text-slate-900" />
                    </div>
                    <div class="space-y-1">
                        <label class="text-sm font-medium text-slate-700">Role</label>
                        <input type="text" value="Partner" disabled class="w-full px-3 py-2 rounded-lg border border-here-gray-200 bg-here-gray-50 text-slate-500 cursor-not-allowed" />
                    </div>
                </div>
                 <div class="space-y-1">
                    <label class="text-sm font-medium text-slate-700">Email Address</label>
                    <input type="email" value="ilya@example.com" class="w-full px-3 py-2 rounded-lg border border-here-gray-200 focus:ring-2 focus:ring-here-purple-500 focus:border-transparent outline-none text-slate-900" />
                </div>
            </div>
            <div class="px-6 py-4 bg-here-gray-50 flex justify-end">
