<template>
    <div class="w-full bg-white rounded-2xl border border-here-gray-200 shadow-lg shadow-slate-200/50 p-2">
        <div class="relative flex items-center gap-2">
            ...
            <input 
                v-model="query"
                type="text"
                class="w-full bg-transparent border-none focus:ring-0 text-slate-800 placeholder-slate-400 pl-10 pr-12 py-3 text-base"
